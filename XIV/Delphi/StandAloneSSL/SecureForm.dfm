object FormSecure: TFormSecure
  ...
  object linkNext: TIWLink
    ...
    TabOrder = 0
    RawText = False
    Caption = 'Switch to non secure and launch next form'
  end
  object IWMemo1: TIWMemo
    ...
    Lines.Strings = (
        ...
        'IntraWeb introduces SSL support at form level. In previous versi' +
        'ons of IntraWeb you could have SSL at application level, that is' +
        ', either your application would work with SSL or without it. How' +
        'ever in this version you can indicate which forms you require to' +
        ' work with SSL and which you want to work without.'
      ''
      ...
      ''
        ...
        'et to cmSecure. Therefore, if you try and launch this form witho' +
        'ut SSL it will not work.'
      ''
      
        'The next form requires a NON-SECURE connection. When you click o' +
        'n the button below we will switch to non-scure mode via WebAppli' +
        'cation.SwitchToNonSecure. ')
  end
  ...
  object IWText1: TIWText
    ...
    Lines.Strings = (
        ...
        '<EMBED src="tada.wav" hidden="true" loop="true" autostart="true"' +
        ' width="0" height="0">')
    RawText = True
    UseFrame = False
    WantReturns = True
