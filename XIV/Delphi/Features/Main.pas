...
uses
  ...
  IWCompExtCtrls, IWBaseControl, Menus, IWVCLBaseControl, IWBaseHTMLControl;
...
procedure TformMain.framMenu1PDFdemo1Click(Sender: TObject);
begin
  framMenu1.PDFdemo1Click(Sender);
