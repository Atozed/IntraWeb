object FormSecure: TFormSecure
  ...
  object IWMemo1: TIWMemo
    ...
    Lines.Strings = (
        ...
        'sions of IntraWeb you could have SSL at application level, that ' +
        'is, either your application would work with SSL or without it. H' +
        'owever in this version you can indicate which forms you require ' +
        'to work with SSL and which you want to work without.'
      ''
